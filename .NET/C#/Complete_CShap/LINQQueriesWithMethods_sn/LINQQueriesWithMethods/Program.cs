...
namespace LINQQueriesWithMethods
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Employees.DisplayWithApparisal(SortEmplyees(listOfEmployees), "After Sorting");
            // 메서드 정렬, 정렬 모듈을 만들어 사용
        }

        public static List<Employees> SortEmplyees(List<Employees> employees)
        {
